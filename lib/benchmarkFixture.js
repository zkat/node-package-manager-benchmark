...
module.exports = async function benchmark (pm, fixture) {
  ...
  let firstInstall
  if (pm === 'npmci') {
    measureInstall(cmdsMap['npm'], cwd)
    firstInstall = 0
  } else {
    firstInstall = measureInstall(cmd, cwd)
  }
  ...
  if (pm === 'npmci') {
    ...
    withWarmCache = measureInstall(cmd, cwd)
  }
  ...
  if (pm === 'npmci') {
    ...
    withWarmCacheAndModules = measureInstall(cmd, cwd)
  }
  ...
  if (pm === 'npmci') {
    ...
    withWarmModules = measureInstall(cmd, cwd)
  }
